...
export const FilmModalEdit = ({
    ...
    return (
        <Modal additionalClass="film-modal" isDisplay={isDisplay} closeCallback={closeCallback}>
            <form action="." method="POST" onSubmit={handleFormSubmit}>
                <div className="modal__header">
                    <p className="modal__title">{modalTitle}</p>
                    <button onClick={closeCallback} type="button" className="modal__close" aria-label="Close"></button>
                </div>
                <div className="modal__body">
                    <div className="film-modal__row film-modal__group">
                        <label className="label">
                            <span className="label__caption">TITLE</span>
                            <FormControl type="text" placeholder="Movie title" value={title} />
                        </label>
                        <label className="label">
                            <span className="label__caption">RELEASE DATE</span>
                            <FormControl type="text" placeholder="Select Date" value={releaseDate} />
                        </label>
                        <label className="label">
                        ...
                        <label className="label">
                            ...
                            <FormControl type="text" placeholder="Input Genre" value={genre} />
                        </label>
                        <label className="label">
